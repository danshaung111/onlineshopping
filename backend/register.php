        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" method="POST" action="addregister.php" enctype="multipart/form-data">
                <div class="form-group">
                  <input type="file" class="form-control-file form-control-user" placeholder="photo" name="user_photo">
                  <?php 
                      if (isset($_SESSION['photo_error_msg'])) {
                  ?>
                  <small class="text-danger"><?php echo $_SESSION['photo_error_msg']; ?></small>
                <?php 
                      } 
                      unset($_SESSION['photo_error_msg']);
                ?>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <input type="email" class="form-control form-control-user" placeholder="email" name="user_email" value="<?php if(isset($_SESSION['old_email'])) echo $_SESSION['old_email'] ?>">
                  <?php 
