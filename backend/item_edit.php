	...
	<div class="offset-md-2 col-md-8">
		<form action="updateitem.php" method="POST" enctype="multipart/form-data">
			...
			<div class="tab-content" id="myTabContent">
				<div class="tab-pane fade show active" id="price" role="tabpanel" aria-labelledby="home-tab"><input type="number" name="price" class="form-control my-3" placeholder="Unit Price" value="<?php echo $item['price']; ?>"></div>
				<div class="tab-pane fade" id="discount" role="tabpanel" aria-labelledby="profile-tab"><input type="number" name="discount" class="form-control my-3" placeholder="Discount Price" value="<?php echo $item['discount']; ?>"></div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<select class="form-control" name="subcategory" id="subcategory">
					...
					?>
					<option value="<?php echo $subcategorie['id']; ?>" <?php if($subcategorie['id']==$item['subcategory_id']) {
						echo "selected";
					} ?>><?php echo $subcategorie['name']; ?></option>
